...
const question33 = new MultipleChoiceImpair('Ability to use media:','','KeepBusy','question33')
const question34 = new MultipleChoiceImpair('Ability to plan a day:','','KeepBusy','question33')
//Feeling man-women
