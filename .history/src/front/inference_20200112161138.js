...
function inference(){
    ...
    var applyYes = 'Based on the given answers we consider that there is a very strong chance to obtain outpatient care and that an an you would most likely obtain outpatient care. Please contact a professional to help you with the procedure.';
