...
function inference(){
    ...
    var applyYes = 'Based on the given answers we consider that there you would most likely obtain outpatient care. Please contact a professional to help you with the procedure.';
