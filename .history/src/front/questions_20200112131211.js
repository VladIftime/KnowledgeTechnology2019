...
const question6 = new MultipleChoiceImpair('Local orientation:','Know where you are or how to get to a place','Orientation','question6')
const question7 = new MultipleChoiceImpair('Personal orientation:','Who am I? Who are the others?','Orientation','question7')
const question8 = new MultipleChoiceImpair('Situational orientation:','Know how to act in a situation','Orientation','question8')
//Movement 
...
const question13 = new MultipleChoiceImpair('Ability to visit infrastructure:','Stores, market, work, doctor etc.','Movement','question13')
//Vital functions
const question14 = new MultipleChoiceImpair('Ability to breath:','','Vital','question14')
const question15 = new MultipleChoiceImpair('Cardio-vascular system:','Heart problems, blood pressure etc.','Vital','question15')
...
const question18 = new TickBox('Body care:','Cannot self-grooming',['Skin','Mouth','Shaving','Hair','Nails','Ears','Nose','Eyes'],'Grooming','question18')
//Eat-Drink
...
const question28 = new MultipleChoiceImpair('Ability to choose appropriate clothing:','Considering weather/events','Dress','question28')
//Rest-Sleep
...
const question31 = new MultipleChoice('Hours of sleep:','On average in a day',['12-10','10-8','8-6','6-4','4-2','2-0'],'RestSleep','question31')
//Keep busy
...
const question43 = new MultipleChoiceImpair('Ability to keep in touch with social contacts:','Family, friends, colleagues etc.','SocialLife','question43')
//existentail questions
const question44 = new TickBox('Experiences of loss:','',['Mourning for a deceased one','Loss of environment or surroundings','Loss of autonomy','Separation from family'],'Existential','question44')
const question45 = new TickBox('Causes for suffering:','',['Illness','Hopelessness','Feeling of worthlessness'],'Existential','question45')
const question46 = new TickBox('Existential Fear:','',['Dying','Illness','Loneliness','Poverty'],'Existential','question46')
